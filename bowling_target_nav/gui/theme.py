...
.settings-window notebook header tab {
    background-color: #0d1117;
    background-image: none;
    padding: 10px 8px;
    border: none;
...
.settings-window notebook header tab:checked {
    background-color: #161b22;
    background-image: none;
    border-right: 3px solid #1f6feb;
}
.settings-window notebook header tab label {
    font-size: 15px;
    font-weight: bold;
    color: #8b949e;
}
.settings-window notebook header tab:checked label {
    color: #ffffff;
}
...
/* ComboBox */
.settings-window combobox button {
    min-height: 30px;
}
"""
